...
class VolumeManager(base.ManagerWithFind):
    ...
    def create(self, size, consistencygroup_id=None, snapshot_id=None,
               ...
               source_replica=None, shareable=None):
        """Create a volume.
    ...
    def list(self, detailed=True, search_opts=None, marker=None, limit=None,
        ...
        url = self._build_list_url(resource_type, detailed=detailed,
                                   ...
                                   sort_dir=sort_dir,offset=offset,metadata=metadata,
                                   changes_since=changes_since,availability_zone=availability_zone)
    ...
    def show_metadata(self, volume):
        """
        Show a volumes metadata.
        :param volume: The :class:`Volume`.
        """
        return self._get("/volumes/%s/metadata" % base.getid(volume),"metadata")
