...
class Manager(common_base.HookableMixin):
    ...
    def _build_list_url(self, resource_type, detailed=True, search_opts=None,
        ...
        if availability_zone:
            query_params['availability-zone'] = availability_zone
