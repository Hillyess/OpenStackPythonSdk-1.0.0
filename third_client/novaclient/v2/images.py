...
class ImageManager(base.ManagerWithFind):
    ...
    def list(self, detailed=True, server=None, name=None, status=None, type=None, changes_since=None, marker=None, limit=None):
        """
        ...
        if changes_since:
            params['changes-since'] = str(changes_since)
